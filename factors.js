var factors = {
	...
	"Сопровождаемость": {
		"Простота конструкции":{
			"Простота архитектуры проекта ПС":["С0101", "С0102"],
			"Сложность архитектуры проекта":["С0201"],
			"Межмодульные связи":["С0301", "С0302", "С0303", "С0304", "С030"],
			"Простота кодирования":["С1001", "С1002"]
		},
		"Наглядность":{
			"Зкспертиза принятой системы идентификации":["С0401"],
			"Комментарии логики программ проекта":["С0801", "С0802", "С0803"],
			"Оформление текста программы":["С0901", "С0902","С0903"]
		},
		"Структурность":{
            "Использование основных логических структур": ["С0501"],
			"Соблюдение принципа нисходящего программирования":["С0601", "С0602", "С0603", "С0604"],
			"Комментарии обоснования декомпозиции программ при кодировании":["С0701"]
		},
		"Повторяемость":{
			"Использование типовых компонентов ПС":["С1301"],
			"Использование типовых проектных решений":["С1401"]
		}
	},
	"Удобство применения": {
		"Легкость освоения":{
		...
		"Доступность эксплутационных программных документов":{
			...
			"Понятность пользовательской документации":["У0501", "У0502", "У0503", "У0504", "У0505", "У0506"],
		...
		"Удобство эксплуатации":{
			...
			"Функция HELP":["У1001", "У1002"],
			"Управление данными":["У1101", "У1102"],
			"Рабочие процедуры (JOBS)":["У1201", "У1202"]
		}
	},
	"Эффективность": {
		"Критерий уровня автоматизации":{
			"Уровень автоматизации":["Э0101", "Э0102","Э0103", "Э0104", "Э0105", "Э0106", "Э0107", "Э0108", "Э0109", "Э0110"]
		},
		"Критерий временной эффективности":{
			"Временная эффективность":["Э0201", "Э0202","Э0203", "Э0205", "Э0206"]
		},
		"Критерий ресурсоемкости":{
	...
	"Универсальность": {
		...
		"Модифицируемость":{
			"Простота кодирования":["Г1001", "Г1002","Г1003", "Г1004", "Г1005", "Г1006", "Г1007"],
	...
	"Корректность": {
		...
		"Согласованность":{
			...
			"Единообразие интерфейсов между модулями и пользователями":["К0501", "К0502","К0503", "К0504", "К0505"],
			...
			"Соответствие ПС документации":["К0901"]
		},
		"Проверенность":{
			"Полнота тестирования проекта":["К1001", "К1002","К1003", "К1004"]
		},
		"Логическая корректность":{
			"Реализация всех решений":["К1101"],
			"Отсутствие явных ошибок и достаточность реквизитов":["К1201"]
		}
	}
};