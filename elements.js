var elements = {
	...
	"С1002": "Оценка простоты программы по числу переходов по условию",
		"C0401": "Экспертиза принятой системы идентификации",
	...
	"С0903": "Оценка ясности и точности описания последовательности функционирования всех элементов программы",
		"С0501": "Использование основных логических структур",
	...
	"С0604": "Оценка программы по числу циклов",
		"С0701": "Комментарии обоснования декомпозиции программ при кодировании",
		"С1301": "Использование типовых компонентов ПС",
		"С1401": "Использование типовых проектных решений",
	...
	"У0503": "Формальная разделенность",	
	...
	"К0806": "Отсутствие ошибок в описании настройки",
		"К0901": "Соответствие ПС документации",
	...
	"К1004": "Отношение числа логических блоков, отработавших в процессе тестирования и отладки ( Q т б ), к общему числу логических блоков в программе ( Q о б )",
		"К1101": "Реализация всех решений",
		"К1201": "Отсутсвие явных ошибок и достаточность реквизитов"
};